...
namespace Drupal\mollo_location\Form;
 ...
 * Class SettingsForm.
 */
class MolloLocationSettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'mollo_location_settings_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('mollo_location.settings');
